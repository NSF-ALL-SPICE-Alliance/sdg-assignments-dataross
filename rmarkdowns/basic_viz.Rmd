...
ggplot(data = sdr_data, aes(x = goal_7_score,y = goal_13_score, color = goal_12_score)) +
  geom_point()
```
There are a few things I have concluded from this graph.  First of all, there are a lot of countries with high goal 13 and goal 12 scores that tend to have lower goal 7 scores. Moreover, darker countries tend to have higher goal 7 scores.
