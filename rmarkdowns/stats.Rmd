...
- Edit the code chunk above to plot a linear regression of 2 different sdg scores 
  ...
  There are many conclusions one can draw from comparing sdg scores 9 and 12. First of all, the strongest correlation between the two scores is a positive correlation with countries having a high goal 12 score and low goal 9 score.  Secondly, there is another positive correlation when countries have a low goal 12 score and a high goal 9 score.  Lastly, there are a decent amount of outlier countries. These countries are in multiple regions ranging from Europe to the Pacific regions. 
